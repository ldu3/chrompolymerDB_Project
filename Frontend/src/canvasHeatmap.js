    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', width: '35%', height: '100%' }}>
            <div ref={containerRef} style={{
                ...
                <Modal open={halfHeatMapModalVisible} onOk={() => setHalfHeatMapModalVisible(false)} onCancel={() => setHalfHeatMapModalVisible(false)} footer={null } width={800} styles={{body: {height: '800px'}}}>
                    <HeatmapTriangle
